...
Page({
    ...
    switchHomeTag: function(t) {
        ...
        e != this.data.nowTag && (this.setData({
            nowTag: e,
            scrollTop: 0
        }), 1 == e && wx.reportAnalytics("video_comments_tab_click"));
    },
    changeOpen: function() {
        this.setData({
    ...
    getAvinfo: function(t, e, s) {
        ...
        i({
            ...
            console.log(n), 0 != n.data.code && wx.redirectTo({
    ...
    onGotUserInfo: function(t) {
        var e = this;
        if (wx.reportAnalytics("video_share_moments_click"), t.detail.userInfo) {
