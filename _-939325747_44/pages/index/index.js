...
Page({
    ...
    scrollFn: function(t) {
        var e = this;
        console.log(t.timeStamp), 0 == this.data.timeStamp ? (this.setData({
            timeStamp: t.timeStamp
        }), setTimeout(function() {
            e.refresh();
        }, 500)) : t.timeStamp - this.data.timeStamp >= 2e3 && this.setData({
            timeStamp: t.timeStamp
        }, function() {
            setTimeout(function() {
                e.refresh();
    ...
    refresh: function() {
        var e = this;
        if (console.log("@-1"), wx.vibrateShort(), wx.reportAnalytics("index_refresh_times", {
            index_refresh_times: ""
        }), this.data.total >= this.data.vLists.length - 1) return this.setData({
            reachbottom: !0,
            isUpdate: !0
        }), this.videoContext && this.videoContext.pause(), void setTimeout(function() {
            e.setData({
                isUpdate: !1
            });
        }, 2e3);
    ...
    refreshBottom: function() {
        console.log("@-2"), wx.vibrateShort(), wx.reportAnalytics("index_refresh_times", {
            index_refresh_times: ""
